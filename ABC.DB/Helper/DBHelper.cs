...
namespace ABC.DB
{
    public static class DBHelper
    {
        ...
        /// <summary>
        /// Create entity - used for tables have primary key - return new id
        /// </summary>
        public static int Add<T>(T entity, string sqlQuery, IDbConnection db)
        {
        ...
        /// <summary>
        /// Create entity - used for tables don't have primary key - return boolean
        /// </summary>
        public static bool Add<T>(IDbConnection db, string sqlQuery, T entity)
        {
            //List<string> rootFields = new List<string>();
